...
\textbf{Need to update the phase plots with halotree version 1088 + use the last timestep + include halo mass in the plot + Increase the fontsize}
...
\begin{figure*}
    ...
    \fig{EarlyRe/Galaxy_CGM_H2phaseplot_Halos_0-0_Snapshot_194.png}{0.47\textwidth}{(b)}}
...
\begin{figure*}
    \gridline{\fig{EarlyRe/Galaxy_CGM_phaseplot_Halos_3-3_Snapshot_194.png}{0.47\textwidth}{(a)}
    \fig{EarlyRe/Galaxy_CGM_H2phaseplot_Halos_3-3_Snapshot_194.png}{0.47\textwidth}{(b)}}
...
\begin{figure*}
    \gridline{\fig{EarlyRe/Halo0_property_comparison_Snapshot_194.png}{0.375\textwidth}{}
    \fig{EarlyRe/Halo0-0_property_evolution_comparison.png}{0.615\textwidth}{}}
...
\begin{figure*}
    \gridline{\fig{EarlyRe/Halo3-3_property_comparison_Snapshot_194.png}{0.375\textwidth}{}
    \fig{EarlyRe/Halo3-3_property_evolution_comparison.png}{0.615\textwidth}{}}
